...
<div class="main-header">
    ...
    <p>Tác giả: Vũ Thế Duy - Trường Tiểu học Vĩnh Lợi - ĐT: 098 9849 628</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vũ Thế Duy - Trường Tiểu học Vĩnh Lợi - ĐT: 098 9849 628</div>", unsafe_allow_html=True)
